...
flags.DEFINE_boolean('save_tflite', True, 'save as tflite')
...
def main(args):
    ...
    output_model_tflite_name = output_model_stem + '.tflite'
    ...
    if FLAGS.save_tflite:
        ...
        logging.info('Saved tflite model at %s',
                     str(Path(output_fld) / output_model_tflite_name))
